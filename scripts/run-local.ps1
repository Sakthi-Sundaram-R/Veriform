...
# The known-good MRTD (enclave measurement) of the quote the dev shim serves.
# Pinning it turns enclave_measurement green and lets the verifier reject a
# genuine enclave running different code.
